"""Read-only reference model for the series table (owned by admin backend)."""
...
# Many-to-many join table (read-only ref)
series_tags = Table(
    "series_tags",
    Base.metadata,
...
# Avoid circular import — forward ref resolved at runtime
