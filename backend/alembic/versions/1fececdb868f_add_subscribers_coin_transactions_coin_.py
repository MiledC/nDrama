...
down_revision: Union[str, Sequence[str], None] = '1d0d625fbba3'
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('anonymous', 'active', 'suspended', 'banned', name='subscriberstatus'), nullable=False),
    ...
    op.create_index(op.f('ix_subscribers_device_id'), 'subscribers', ['device_id'], unique=False)
    ...
    sa.Column('price_sar', sa.Numeric(precision=10, scale=2), nullable=False),
    ...
    sa.Column('type', sa.Enum('purchase', 'spend', 'refund', 'promo', 'adjustment', name='transactiontype'), nullable=False),
    ...
    op.create_index(op.f('ix_coin_transactions_subscriber_id'), 'coin_transactions', ['subscriber_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_coin_transactions_subscriber_id'), table_name='coin_transactions')
